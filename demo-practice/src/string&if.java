public class firstweekpractice {
  public static void main(String[] args) {
    ...
    //System.out.println(s.equalsIgnoreCase("FIRSTWEEKPRACTICE"));// true
    ...
    // case loop, from 1-100, an even number, money +1
   // for(int i= 1; i <=100; i++) {
      //if (i%2 == 0) {
        //money += 4;
      //}
   ...
   if (u%4 == 0) {
    ...
    money += 6;
   }System.out.println(money); // a case cant use else if as there are overlaps
   // else if case
   // >=90 grade a
   // >=75 grade b
   // >=60 grade c
